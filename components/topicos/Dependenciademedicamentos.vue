<template>
    ...
    <p> Tem sido cada vez mais comum encontrar jovens e adultos com doenças
        ...
        do Sistema Único de Saúde (SUS) referentes à depressão aumentaram 52% entre 
        2015 e 2018. Eram mais de 121 mil pessoas e, dentre a população na faixa
        dos 15 e 29 anos, o aumento foi de 115%.</<br/><br/>
        Entre as possíveis razões para isso estão as mudanças que a última década 
        trouxe no campo social, cultural, político, econômico e profissional. 
        Além disso, estamos inseridos em uma realidade de padrões extremos, altas 
