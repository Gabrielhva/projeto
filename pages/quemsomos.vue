...
<template>
    ...
    <h2 class="ajustequemsomos">Bem-vindo ao Portal Saúde + </h2>
    ...
    <p>No nosso portal, estamos comprometidos em oferecer informações de saúde confiáveis, 
        ...
        <h2 class="ajustequemsomos2">NOSSA MISSÃO</h2>
    <div class="conteudoquemsomos">
    ...
    <h2 class="ajustequemsomos2">NOSSA EQUIPE</h2>
    ...
    <h2 class="compromissoqualidade">COMPROMISSO COM A QUALIDADE</h2>
    

    <p class="conteudocompromissoqualidade">Todas as informações no Portal Saúde são revisadas por profissionais 
    ...
    <h2 class="ajustequemsomos2">O QUE OFERECEMOS</h2>
