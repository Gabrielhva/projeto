...
<template>
    ...
    <p><strong>As compulsões comuns incluem:</strong></p>
   
    <ul><li>Lavar ou limpar algo para evitar contaminação </li>
    ...
    <li>Ordenar (por exemplo, arrumar talheres ou objetos da mesa de trabalho em um padrão específico) </li> </ul> 
    <br/>

    <p>parte dos rituais, como lavar as mãos com muita frequência ou verificar repetidamente se a porta está trancada, pode ser observada. Outros rituais não podem ser observados, tais como ficar contando repetidamente na mente ou ficar fazendo afirmações em voz baixa com a intenção de diminuir algum perigo.
