...
As flutuações de humor têm reflexos negativos sobre o comportamento e atitudes dos pacientes, e a reação que provocam é sempre desproporcional aos fatos que serviram
de gatilho ou, até mesmo, independem deles.
...
familiares, afetivos e sociais, como também o desempenho profissional, a posição econômica e a segurança do paciente e das pessoas que com ele convivem. O quadro pode ser
...
Da mesma forma, já ficou demonstrado que alguns eventos podem precipitar a manifestação desse distúrbio do humor nas pessoas geneticamente predispostas. Entre eles,
destacam-se:
episódios frequentes de depressão ou início precoce dessas crises, puerpério, estresse prolongado, remédios inibidores do apetite (anorexígenos e anfetaminas), e
disfunções da
...
do pânico, distúrbios da ansiedade. Daí a importância de estabelecer o diagnóstico diferencial antes de propor qualquer medida terapêutica.
<br/><br/>

<strong>Sintomas</strong>
<br/>

Entre os principais sintomas em cada fase do transtorno bipolar, estão:
<br/><br/>
   

Depressão: humor deprimido, tristeza profunda, apatia, desinteresse pelas atividades que antes davam prazer, isolamento social, alterações do sono e do apetite,
redução significativa da libido, dificuldade de concentração, cansaço, sentimentos recorrentes de inutilidade, culpa excessiva, frustração e falta de sentido para 
a vida, esquecimentos, ideias suicidas.
Mania: estado de euforia exuberante, com valorização da autoestima e da autoconfiança, pouca necessidade de sono, agitação psicomotora, descontrole ao coordenar as ideias,
desvio da atenção, compulsão para falar, aumento da libido, irritabilidade e impaciência crescentes, comportamento agressivo, mania de grandeza. Nessa fase, o paciente pode 
tomar atitudes que reverterão em danos a si próprio e às pessoas próximas, como demissão do emprego, gastos descontrolados de dinheiro, envolvimentos afetivos apressados, 
atividade sexual aumentada e, em casos mais graves, delírios e alucinações.
Hipomania: os sintomas são semelhantes aos da mania, porém bem mais leves e com menor repercussão sobre as atividades e relacionamentos do paciente, que se mostra mais eufórico, mais
falante, sociável e ativo do que o habitual. Em geral, a crise é breve, dura apenas uns poucos dias. Para efeito de diagnóstico, é preciso assegurar que a reação não foi induzida pelo
uso de antidepressivos.



De acordo com o tipo, gravidade e evolução da doença, a prescrição de medicamentos neurolépticos, antipsicóticos, anticonvulsivantes, ansiolíticos e estabilizadores de humor,
especialmente o carbonato de lítio, tem-se mostrado útil para reverter os quadros agudos de euforia e evitar a recorrência das crises. A associação de lítio com antidepressivos
e anticonvulsivantes tem demonstrado maior eficácia para prevenir recaídas. No entanto, os antidepressivos devem ser utilizados com cuidado, porque podem provocar uma guinada 
rápida da depressão para a euforia, ou acelerar a incidência das crises.
A psicoterapia é outro recurso importante no tratamento da bipolaridade, uma vez que oferece suporte para o paciente superar as dificuldades impostas pelas características da doença,
ajuda a prevenir a recorrência das crises e, especialmente, promove a adesão ao tratamento medicamentoso que, como ocorre na maioria das doenças crônicas, deve ser mantido por toda a vida.
<br/><br/>
