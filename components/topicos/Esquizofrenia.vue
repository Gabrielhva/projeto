...
<template>
    ...
    notados sintomas.</p>
    <h2> Sintomas de esquizofrenia</h2> 
    <ul>Os principais sintomas de esquizofrenia, que variam de pessoa para pessoa, são: <br/> <br/>
        
        <li><strong>Delírios</strong>, que surgem quando a pessoa acredita vivamente em algo que não é real, como que está sendo perseguida, traída ou que tem superpoderes, por exemplo.</li>
        <li> <strong>Alucinações</strong>, são percepções vívidas e claras de coisas que não existem, como ouvir vozes ou ter visões;
            Pensamento desorganizado, em que a pessoa fala coisas desconexas e sem sentido; </li>
        <li><strong>Anormalidades na forma de se movimentar</strong>, com movimentos descoordenados e involuntários, além do catatonismo, caracterizado pela falta de movimentação, presença de movimentos repetidos, olhar fixo, caretas, eco da fala ou ficar mudo, por exemplo;</li>
        <li><strong>Alterações do comportamento</strong>, podendo haver surtos psicóticos, agressividade, agitação e risco de suicídio;</li>
