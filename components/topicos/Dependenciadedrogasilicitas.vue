<template>
    ...
    <ul>
        ...
        <br/><br/>
        <li>Um forte desejo para as consumir;</li>
        <li>Dificuldades em controlar o comportamento, tanto no que se refere ao início, fim e níveis de consumo;</li>
        <li>Estado de abstinência fisiológico quando o uso cessa ou é reduzido;</li>
        <li>Evidência de tolerância, na qual doses crescentes são necessárias para se obter um efeito inicialmente obtido com dosagens mais baixas;</li>
        <li>Abandono progressivo de prazeres e interesses alternativos em favor do seu uso e aumento da quantidade de tempo necessária para se recuperar dos seus efeitos;</li>
        <li>Persistência na sua utilização, apesar da evidência de consequências manifestamente nocivas.</li>
    </ul>
    <h2>Sintomas</h2>
    <p>Muitas iniciam-se de uma forma meramente casual, num determinado contexto social. Esse consumo vai-se tornando mais habitual até adquirir as características de uma dependência, requerendo quantidades cada vez maiores e com uma utilização cada vez mais frequente. <br/>
        Ao longo do tempo, essa substância torna-se essencial para que a pessoa se sinta bem e capaz de ser funcional no seu dia-a-dia. Sendo que a ausência gera desconforto físico e emocional (abstinência).<br/>
        As manifestações típicas passam pela sensação de necessidade de um consumo cada vez mais regular, pela incapacidade de o interromper, pela indispensabilidade de manter sempre uma reserva da substância, pelo gasto excessivo de dinheiro, muitas vezes acima das possibilidades, pela impressão de que o seu uso é essencial para se conseguir ultrapassar os problemas diários, pela realização de atividades arriscadas sob influência desse elemento e pelo crescente gasto de tempo e energia na sua obtenção e utilização.<br/>
    ...
    <h3>Causas</h3>
    <p>
        Relaciona-se com as características químicas da droga ou da substância, com o perfil psicológico do consumidor e com o meio ambiente onde ele está inserido.<br/><br/>
        No que se refere às características, o tabaco e o café, por exemplo, não alteram de forma significativa o comportamento do consumidor e, por isso, são compatíveis com uma vida social normal. No entanto, o tabaco pode não dar alterações de comportamento mas pode provocar problemas graves da saúde.<br/><br/>
        No que se refere às características psicológicas do consumidor, a adolescência é uma fase difícil para cerca de um terço dos jovens que pode provocar frustrações que impelem à fuga para estas substâncias. A adolescência é, por definição, uma época de experimentação e de procura dos limites do "eu", o que leva frequentemente à iniciação nas drogas.<br/><br/>
...
No que se refere ao meio ambiente, o papel da família, da escola, do local de trabalho pode ser determinante no aparecimento de uma dependência ou, inversamente, na sua deteção e correção precoces.  
    ...
    <p>O tratamento deverá ser sempre individualizado. Nalguns casos, um regime de internamento é eficaz porque permite interromper a progressão e o agravamento dos sintomas associados à doença, bem como todo o seu impacto na saúde do paciente, na sua família, no trabalho ou nas suas finanças.
...
Nos casos de indivíduos recuperados, existe sempre o risco de recaída pelo que se deve evitar o contacto com a substância bem como todas as situações de risco.</p>
